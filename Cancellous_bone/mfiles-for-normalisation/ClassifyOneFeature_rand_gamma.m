function acc = ClassifyOneFeature_rand_gamma
...
% only. Randomises Hmat by fitting a gamma distribution to the values of
% the Hmat vector, and then randomly generating values from this gamma
% distribution.
...
theta = (s^2)/m;      % scale parameter 

Hmat_new = gamrnd(k,theta,90,1);

load Cohortmat
[confusmat,acc] = LDAclassify9(Hmat_new,Cohortmat,1);