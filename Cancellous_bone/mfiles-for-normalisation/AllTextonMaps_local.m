function Hmat = AllTextonMaps_local(TextonMat,tol)

% August 12 2014 (Rostock). Edited by Amelia 4 November 2015.
%
...
for kR = 1:30       % counter for rats
    for kB = 1:3    % counter for sub-blocks
        ...
        for v = 1:V
            ...
            thetamat_new(v,:) = fvec_new;
        end 
        
        % Compute the texton map for the current sub-block
        [Tmap,Dvec] = TextonMap(TextonMat,thetamat_new);
