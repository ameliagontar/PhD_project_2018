function [bestacc,bestF,bestconfus,accvec] = Exp1F3_random(NC)
...
% optimal accuracy. NC is the number of textons per class.
%
...
TextonArray3D = TextonKmeans_random(NC);
...
Hmat = AllTextonMaps_random(AllTextons2D);
