...
maxk = 121;         % maximum length of line segments considered is 2*maxk+1
    ...
    if namelen > 2
        ...
        if isequal(w08,c8) == 1
            ...
            for kb = 1:3
                ...
                cd(hdir)
                thetamat = ThicknessFeatures4or13(curB,maxk,M,ssf);
