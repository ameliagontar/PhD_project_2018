function [NOFmat,ACCmat,lambdavec] = Exp4V1F3

% October 3 2014 (Rostock)
%
% This version uses azimuth free feature vectors of length 13 as described
% in the notes for October 2 2014. The feature vectores are stored in the
% directory ..../Combined13.
%
...
lambdavec = [.1 .25 .5 .75 1.0 1.3 1.6 2.0]
%lambdavec = [ 1 2];
