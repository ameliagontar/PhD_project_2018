function [cpvec,cavec] = Exp1F3SkelTrials

% 23 April 2015
%
% The aim is to run the program Exp1F3Skel.m N times, and produce a vector
...
for k = 0:N-1
    k = k+1;
    try
    bestacc_k = Exp1F3Skel;
    catch
        try                         % needs a few more try and catch loops
            bestacc_k = Exp1F3Skel; % because Exp1F3Skel seems to fail more 
