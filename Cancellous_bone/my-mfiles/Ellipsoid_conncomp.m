...
% is the centroid of the ellipsoid, V1 is the row vector in the major
% direction, V2 is the row vector in the middle direction, and V3 is is the
% row vector in the minor direction. lgths is the row vector of the lengths
...
% Sort into the major, middle and minor directions:
normeig = [n1,n2,n3];
[lgths,idx] = sort(normeig,'descend');
V1 = V(:,idx(1));
V1 = V1';
V2 = V(:,idx(2));
V2 = V2';
