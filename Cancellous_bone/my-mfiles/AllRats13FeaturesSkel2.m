function AllRats13FeaturesSkel2

% 30 April 2015 
%
% Very closely based on Murk's AllRats13Features.m.
%
% This program uses the program ThicknessFeatures4or13Skel2.m to compute the
    ...
    if namelen > 2
        ...
        if isequal(w08,c8) == 1
            ...
            for kb = 1:3
                ...
                bname = [sname(1:8) 'B' int2str(kb) 'skel2'];
                ...
                cd(hdir)
                thetamat = ThicknessFeatures4or13Skel2(curB,maxk,M);
